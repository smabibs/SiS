...
export default function SarprasPengajuanPage() {
    ...
    const fetchRequests = useCallback(async () => {
        ...
        const res = await fetch(`/api/sarpras/pengajuan?${params}`);
    ...
    const handleSave = async () => {
        ...
        const res = await fetch('/api/sarpras/pengajuan', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(form) });
    ...
    const handleDelete = async (r: Request) => {
        ...
        const res = await fetch(`/api/sarpras/pengajuan/${r.id}`, { method: 'DELETE' });
    ...
    return (
        <>
            <div className="page-header">
                <div><h1>Pengajuan Inventaris Sarpras</h1><p>Pengajuan kebutuhan fasilitas dan barang sarpras baru</p></div>
